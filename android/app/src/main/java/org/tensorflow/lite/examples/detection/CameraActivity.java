...
import org.tensorflow.lite.examples.detection.Model.QRURLModel;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    Dexter.withActivity(this).withPermission(Manifest.permission.CAMERA).withListener(new PermissionListener() {
      ...
      public void onPermissionGranted(PermissionGrantedResponse response) {
        ...
        scannerView.setResultHandler(CameraActivity.this);
  ...
  private void processRawResult(String text) {
    if (text.startsWith("http://") || text.startsWith("https://") || text.startsWith("www.")){
      ...
      Toast.makeText(this, "이동 :"+qrurlModel.getUrl(), Toast.LENGTH_SHORT).show();

    }
    Log.d(TAG, "processRawResult: !!!!!!!!!!!!!!!!!!!!!!");
